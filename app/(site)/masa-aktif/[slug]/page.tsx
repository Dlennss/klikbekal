...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Masa Aktif Semua Operator | KlikBekal",
      description: "Perpanjang masa aktif nomor Anda di KlikBekal.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | KlikBekal`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di KlikBekal. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di KlikBekal dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
    keywords: [`masa aktif ${brand.nama.toLowerCase()}`, `perpanjang masa aktif ${brand.nama.toLowerCase()}`, "KlikBekal"],
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | KlikBekal`,
    description: `Perpanjang masa aktif ${brandTitle} di KlikBekal dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di KlikBekal tersedia dalam beberapa pilihan?`,
      answer: `Ya. KlikBekal menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di KlikBekal?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member KlikBekal untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
