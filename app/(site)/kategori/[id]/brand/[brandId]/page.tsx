...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} KlikBekal`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di KlikBekal.`,
    path: `/kategori/${id}/brand/${brandId}`,
    keywords: [String(brand).toLowerCase(), String(categoryName).toLowerCase(), "KlikBekal"],
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} KlikBekal`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di KlikBekal.`,
    path: `/kategori/${id}/brand/${brandId}`,
