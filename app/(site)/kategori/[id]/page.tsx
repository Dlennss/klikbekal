...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | KlikBekal`,
      description: "Layanan digital KlikBekal.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | KlikBekal",
      description: "Lihat kategori produk KlikBekal.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | KlikBekal`,
    description: `Lihat pilihan brand dan produk ${category.nama} di KlikBekal.`,
    path: `/kategori/${id}`,
    keywords: [String(category.nama).toLowerCase(), "produk KlikBekal", "KlikBekal"],
  });
}
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | KlikBekal`,
    description: `Lihat pilihan brand dan produk ${categoryName} di KlikBekal.`,
    path: `/kategori/${id}`,
