...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar tagihan gas PGN di KlikBekal dengan langkah pembayaran yang ringkas.",
  path: "/pgn",
  keywords: ["bayar pgn online", "tagihan gas pgn", "cek tagihan pgn", "KlikBekal"],
});
