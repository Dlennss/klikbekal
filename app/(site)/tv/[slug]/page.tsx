...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | KlikBekal",
      description: "Beli paket atau bayar layanan TV berlangganan di KlikBekal.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan KlikBekal`,
    description: `Beli paket atau bayar layanan ${brand.nama} di KlikBekal dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
    keywords: [`${brand.nama.toLowerCase()}`, `bayar ${brand.nama.toLowerCase()}`, "tv berlangganan", "KlikBekal"],
