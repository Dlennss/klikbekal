...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | KlikBekal",
      description: "Pilih produk aktivasi perdana operator di KlikBekal.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | KlikBekal`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di KlikBekal. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di KlikBekal dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
    keywords: [`aktivasi perdana ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} perdana`, "KlikBekal"],
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | KlikBekal`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di KlikBekal dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di KlikBekal tersedia lengkap?`,
      answer: `Ya. KlikBekal menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di KlikBekal?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member KlikBekal untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
