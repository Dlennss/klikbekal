...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up Game Online | KlikBekal",
      description: "Top up game online favorit Anda di KlikBekal.",
      path: "/game",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Murah | KlikBekal`,
    description: lowestPrice
      ? `Top up ${brandTitle} di KlikBekal dengan pilihan nominal aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Top up ${brandTitle} di KlikBekal dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} murah`, "voucher game", "KlikBekal"],
...
export default async function GameBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Murah | KlikBekal`,
    description: `Top up ${brandTitle} di KlikBekal dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di KlikBekal tersedia dalam banyak pilihan nominal?`,
      answer: `Ya. KlikBekal menampilkan produk ${brandTitle} yang aktif agar pembeli bisa memilih nominal yang sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara top up ${brandTitle} di KlikBekal?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member KlikBekal untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
