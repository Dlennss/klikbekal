...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Top up DANA, OVO, GoPay, LinkAja, dan ShopeePay di KlikBekal dengan nominal tetap maupun bebas nominal.",
  path: "/ewallet",
  keywords: ["top up dana", "top up ovo", "top up gopay", "top up linkaja", "ewallet KlikBekal"],
});
