...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up E-Wallet | KlikBekal",
      description: "Top up e-wallet favorit Anda di KlikBekal.",
      path: "/ewallet",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Online | KlikBekal`,
    description: lowestPrice
      ? `Top up ${brandTitle} online di KlikBekal dengan nominal tetap dan bebas nominal. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Top up ${brandTitle} di KlikBekal dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} KlikBekal`, "ewallet"],
...
export default async function EwalletBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Online | KlikBekal`,
    description: `Top up ${brandTitle} di KlikBekal dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di KlikBekal bisa pilih nominal tetap dan bebas nominal?`,
      answer: `Ya. KlikBekal menampilkan produk ${brandTitle} yang aktif, termasuk nominal tetap dan varian bebas nominal bila tersedia.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dipakai untuk kebutuhan top up pribadi maupun penjualan ulang oleh member KlikBekal.`,
    },
  ]);
