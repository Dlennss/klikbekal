...
export const metadata: Metadata = buildPageMetadata({
  title: "Token Listrik PLN | KlikBekal",
  description: "Beli token listrik PLN di KlikBekal dengan pilihan nominal dan grup produk yang lebih jelas.",
  path: "/listrik/token",
  keywords: ["token listrik", "token pln", "beli token listrik", "KlikBekal listrik"],
