...
export const metadata: Metadata = buildPageMetadata({
  title: "Tagihan Listrik PLN | KlikBekal",
  description: "Bayar tagihan listrik PLN di KlikBekal dengan alur yang ringkas untuk pelanggan rumah tangga dan agen.",
  path: "/listrik/tagihan",
  keywords: ["tagihan listrik", "bayar listrik", "pln pascabayar", "KlikBekal listrik"],
});
