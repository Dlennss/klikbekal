...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug !== "kesehatan" && slug !== "ketenagakerjaan") {
    return buildPageMetadata({
      title: "BPJS | KlikBekal",
      description: "Cek dan bayar BPJS di KlikBekal.",
      path: "/bpjs",
    });
  }
  ...
  return buildPageMetadata({
    title: `${title} | KlikBekal`,
    description: `Cek dan bayar ${title} di KlikBekal dengan alur yang ringkas.`,
    path: `/bpjs/${slug}`,
    keywords: [title.toLowerCase(), "bayar bpjs", "KlikBekal"],
  });
}
