...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!phoneCategory) {
    return buildPageMetadata({
      title: "Paket Telepon Semua Operator | KlikBekal",
      description: "Pilih paket telepon operator di KlikBekal.",
      path: "/paket-telepon",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Telepon ${brandTitle} | KlikBekal`,
    description: lowestPrice
      ? `Pilih paket telepon ${brandTitle} di KlikBekal. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih paket telepon ${brandTitle} di KlikBekal dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
    keywords: [`paket telepon ${brand.nama.toLowerCase()}`, `nelpon ${brand.nama.toLowerCase()}`, "KlikBekal"],
...
export default async function GuestPaketTeleponBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Telepon ${brandTitle} | KlikBekal`,
    description: `Pilih paket telepon ${brandTitle} di KlikBekal dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket telepon ${brandTitle} di KlikBekal tersedia dalam banyak pilihan?`,
      answer: `Ya. KlikBekal menampilkan paket telepon ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli paket telepon ${brandTitle} di KlikBekal?`,
