...
const pageTitle = "Privacy Policy KlikBekal | Website and Android App";
const pageDescription =
  "Privacy policy for KlikBekal website and Android application, including account data, transactions, security, and Google sign-in usage.";
