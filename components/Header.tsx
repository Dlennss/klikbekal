  ...
  return (
    <header className="sticky top-0 z-50 overflow-hidden bg-[#052e26] text-white shadow-[0_16px_34px_rgba(5,46,38,0.22)]">
      ...
      <div className="mx-auto flex h-18 w-full max-w-7xl items-center justify-between gap-3 px-4">
        <Link href="/" className="flex items-center gap-3" aria-label="KlikBekal">
          <KlikBekalBrandLogo showWordmark={false} markClassName="h-11 w-11 shrink-0 rounded-2xl" />
          <span className="min-w-0">
            <span className="block text-xl font-black tracking-normal">KlikBekal</span>
