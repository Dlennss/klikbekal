...
const fallbackAds: GuestAdItem[] = [
  {
    ...
    judul: "",
    keterangan: "",
    image_url: "/klikbekal-assets/hero-topup-3d.png",
    link_url: "/pulsa",
    urutan: 1,
    aktif: true,
  },
...
const KlikBekalBannerUrls = [
  "/klikbekal-assets/hero-topup-3d.png",
  "/klikbekal-assets/hero-topup-3d.png",
  "/klikbekal-assets/hero-topup-3d.png",
];
...
function normalizeAdBanner(item: GuestAdItem, index: number): GuestAdItem {
  ...
  return {
    ...
    judul: "",
    keterangan: "",
    image_url: KlikBekalBannerUrls[index % KlikBekalBannerUrls.length],
  };
}
        ...
        {ads.map((item, index) => {
          ...
          const content = (
            ...
            >
              <Image
                src={item.image_url}
                alt={item.judul || 'Iklan KlikBekal'}
                fill
                sizes="(min-width: 768px) 374px, (max-width: 448px) calc(100vw - 16px), 432px"
                className="object-cover"
                loading="eager"
                fetchPriority={index === 0 ? "high" : "low"}
                unoptimized={!item.image_url.startsWith('/KlikBekal-assets/')}
              />
              {hasCaption ? (
                <>
