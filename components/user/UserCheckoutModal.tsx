...
function buildGuestIdentity(dest: string) {
  ...
  return {
    guestNama: "Guest KlikBekal",
    guestEmail: phone ? `guest-${phone}@KlikBekal.local` : "guest@KlikBekal.local",
    guestPhone: phone,
  };
}
...
export function UserCheckoutModal({
  ...
  function handleDownloadProof() {
    void (async () => {
      ...
      doc.setFontSize(11);
      doc.text("KlikBekal - QRIS Payment Receipt", centerX, 61, { align: "center" });
      doc.setFontSize(10);
      ...
      doc.setFont("helvetica", "normal");
      doc.text("Dokumen ini dibuat otomatis oleh sistem KlikBekal dan valid sebagai bukti pembayaran.", 56, finalY + 58);
