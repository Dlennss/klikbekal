...
SOURCE_DIR="${SOURCE_DIR:-/var/lib/syslog-ng/KlikBekal/KlikBekal-fe}"
RELEASE_ROOT="${RELEASE_ROOT:-/var/lib/syslog-ng/KlikBekal/releases/KlikBekal-fe}"
...
SERVICE_NAME="${FRONTEND_SERVICE_NAME:-KlikBekal-fe.service}"
